    ...
    <div className="text-white  bg-black b ">
        <div className="md:grid md:grid-cols-2">
            <div className="md:ml-20 pt-20 ">
                <h1 className="text-5xl md:text-6xl mb-6 font-bold text-white text-center md:text-left inter">Contact Us</h1>
                <p className="text-md mb-6 text-white inter text-left text-zinc-500 mr-10 ml-10 md:ml-0">
                ...
                <p className='ml-10 md:ml-0'> Sydney Wirdeu : <a href="mailto:sydneywiredu@circlez-online.com" className="text-blue-400"> sydneywiredu@circlez-online.com </a> </p>
                <p className='ml-10 md:ml-0'> Aiden Tahmazian : <a href="mailto:atahmazian@circlez-online.com" className="text-blue-400"> atahmazian@circlez-online.com </a> </p>
