  ...
  return (
    <div>
        ...
        <div className="md:ml-20 pt-20 ">
          <h1 className="text-5xl mb-6 font-bold text-white text-center md:text-left inter">What We're About</h1>
          <p className="text-md mb-6 text-white inter text-left text-zinc-500 ml-10 mr-10 md:ml-0">
        ...
        <div className="md:mr-20 pt-20 ">
          <h1 className="text-5xl mb-6 font-bold text-white text-center md:text-right inter">Our Why</h1>
          <p className="text-md text-white md:text-right inter text-zinc-500 ml-10 mr-10 md:mr-0">
