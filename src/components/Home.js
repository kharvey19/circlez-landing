...
const Home = () => {
  ...
  <button onClick={handleOpen} className="hover:cursor-pointer mt-5 md:mt-7 border-2 rounded-md p-3 pl-10 pr-10 bg-indigo-400	 text-sm text-white border-indigo-400 hover:bg-black hover:text-indigo-400 font-bold md:inter">Enter Here</button>
  <div>
