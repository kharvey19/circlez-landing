...
const Home = () => {
    ...
    <p className="text-white text-6xl inter font-bold pt-44  text-center "> A <span className='text-indigo-400'> hub </span> for motivation.</p>
      <div className="md:grid md:grid-cols-2 ">
        <div className=" mr-10 md:mr-0 md:ml-40 md:pt-20 col-span-1 mb-36 pt-16">
            <p className="ml-12 text-white text-center md:text-left md:mt-32 text-3xl md:text-4xl font-bold">A social media app startup harnessing the power of positive peer pressure to help young adults track and achieve goals.</p>
        ...
        <div className="md:pt-20 flex justify-center flex-col md:flex-row items-center md:col-span-1">
        <div className='md:mt-10 md:mr-5 '>
        <img src={home} alt='' className="h" />
        </div>
        <div className='mt-20 mb-20 md:mr-5 '>
